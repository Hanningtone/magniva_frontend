...
export { default as AttendeesForm} from './forms/AttendeesForm';
export { default as HotelForm } from './forms/InvitesForm';
...
export {default as AttendanceForm} from './forms/AttendanceForm';
